...
export function ValuesSection({ locale }: { locale: Locale }) {
  ...
  return (
    <section id="values" className="py-32 lg:py-40 bg-secondary/30">
        ...
        <div className="mt-16 grid grid-cols-2 gap-6 md:grid-cols-5 lg:gap-8">
          {t.items.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="group flex flex-col items-center text-center rounded-2xl border border-border bg-card p-8 shadow-sm transition-all hover:shadow-md hover:border-primary/30"
              >
